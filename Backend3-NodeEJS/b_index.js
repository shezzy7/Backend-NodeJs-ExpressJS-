...
//For creating ejs templates we've made a directiry named as views.Then in this directory we create files with extension ejs.
//Then while sending response from res method , instead writing res.send(data) we write res.render("fileName from views folder");

// our res method first of all will find 'views' named directory then will find file matching with given name ,and will render it on page. 
app.get("/",(req,res)=>{
